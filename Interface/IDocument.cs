...
public class IDocument
{
    ...
    /// <list type="bullet">
    ///   <item><description>[BsonId] - Marks this property as the primary key</description></item>
    ///   <item><description>[BsonRepresentation(BsonType.String)] - Specifies the ID should be stored as string in the database</description></item>
    /// </list>
